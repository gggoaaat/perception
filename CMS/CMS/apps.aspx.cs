...
namespace CMS
{
    public partial class Apps : System.Web.UI.Page
    {
        ...
        protected DataTable InsertProcedure(string name,int application_id)
        {
            ...
            ParamList0.Add(new DB_Toolbox.DBParameters { ParamName = "P_NAME", ParamValue=name, ParamDBType = Oracle.DataAccess.Client.OracleDbType.Varchar2, ParamDirection = System.Data.ParameterDirection.Input, ParamSize = 100  });
            ParamList0.Add(new DB_Toolbox.DBParameters { ParamName = "P_USER_ID", ParamValue = "1000", ParamDBType = Oracle.DataAccess.Client.OracleDbType.Int32, ParamDirection = System.Data.ParameterDirection.Input });
            ParamList0.Add(new DB_Toolbox.DBParameters { ParamName = "R_APPLICATIONS_ID", ParamDBType = Oracle.DataAccess.Client.OracleDbType.Int32, ParamDirection = System.Data.ParameterDirection.Output });
            string tempvalue = "";
            ...
            {
                ParamName = "P_NAME", ParamDirection = ParameterDirection.Input, ParamDBType = OracleDbType.Varchar2, ParamSize = 100, ParamValue = name
            });

            ParamList1.Add(new DB_Toolbox.DBParameters
            {
                ParamName = "P_APPLICATIONS_ID", ParamDirection = ParameterDirection.Input, ParamDBType = OracleDbType.Int32, ParamValue = tempvalue,

            });

            ParamList1.Add(new DB_Toolbox.DBParameters
            {
                ParamName = "P_VERSION", ParamDirection = ParameterDirection.Input, ParamDBType = OracleDbType.Int32, ParamValue = "10",

            });

            ParamList1.Add(new DB_Toolbox.DBParameters
            {
                ParamName = "P_PUBLISHED", ParamDirection = ParameterDirection.Input, ParamDBType = OracleDbType.Varchar2, ParamValue = "Y",

            });

            ParamList1.Add(new DB_Toolbox.DBParameters
            {
                ParamName = "R_APPLICATION_NAME_ID", ParamDirection = ParameterDirection.Output, ParamDBType = OracleDbType.Int32, ParamSize = 100
            });
