...
namespace CMS
{
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        protected void CreateDB(string SystemName)
        {
            ...
            EMIN_DBK.EP_CREATE_DB("ORACLE", constr, constr1, SystemName, "alpha123");
        ...
        protected void Submit_Click(object sender, EventArgs e)
        {
                ...
                Request.Form["Usertxt"].Length > 1 && Request.Form["Passwordtxt"].Length > 1)
            {
                ...
                ConnectionStringSettings StringSettings = new ConnectionStringSettings("DBConnection", "Data Source=" + Request.Form["DataSourcetxt"] + ";User ID=" + Request.Form["Usertxt"] + ";Password=" + Request.Form["Passwordtxt"] + ";");
