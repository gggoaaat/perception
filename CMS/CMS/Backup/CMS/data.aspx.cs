...
namespace CMS
{
    public partial class Data : System.Web.UI.Page
    {
        ...
        string constrSQLServer1 = System.Configuration.ConfigurationManager.ConnectionStrings["SQLServerDBConnection1"].ToString();
        string constrSQLServer2 = System.Configuration.ConfigurationManager.ConnectionStrings["MSSQLDBConnection"].ToString();
        ...
        protected void submitOracleServer_Click(object sender, EventArgs e)
        {
            ...
            Results = EMIN_DBK.EP_CREATE_DB("ORACLE", constr, constr1, "PerceptionDB", "alpha123");
           ...
           /* 
            InstallerHolder.Controls.Add(new LiteralControl(EMIN_DBK.SQL_Add_PROC_INSERT("ORACLE", constr1, "APPLICATION","")));
            InstallerHolder.Controls.Add(new LiteralControl("<hr />"));
            InstallerHolder.Controls.Add(new LiteralControl(EMIN_DBK.SQL_Add_PROC_INSERT("ORACLE", constr1, "LOG", "")));
            InstallerHolder.Controls.Add(new LiteralControl("<hr />"));
            InstallerHolder.Controls.Add(new LiteralControl(EMIN_DBK.SQL_Add_PROC_INSERT("ORACLE", constr1, "ROLES", "")));
            InstallerHolder.Controls.Add(new LiteralControl("<hr />"));
            InstallerHolder.Controls.Add(new LiteralControl(EMIN_DBK.SQL_Add_PROC_UPDATE("ORACLE", constr1, "APPLICATION", "")));
            InstallerHolder.Controls.Add(new LiteralControl("<hr />"));
            InstallerHolder.Controls.Add(new LiteralControl(EMIN_DBK.SQL_Add_PROC_DELETE("ORACLE", constr1, "APPLICATION", "")));
            InstallerHolder.Controls.Add(new LiteralControl("<hr />"));
        ...
        protected void submitSqlServer_Click(object sender, EventArgs e)
        {
            ...
            Results = EMIN_DBK.EP_CREATE_DB("Microsoft", constrSQLServer, constrSQLServer1, "PerceptionDB", "Echoomeg@1");
        ...
        protected void GET_COLUMNS_FOR_TABLE()
        {
            ...
            dg2.DataSource = EMIN_DBK.SQL_SELECT_COLUMNS_FROM_USER_TABLES("Oracle", constr1, "Application", false);
            dg2.DataBind();
        ...
        protected void createView()
        {
            ...
            string test = EMIN_DBK.SQL_Add_View("ORACLE", constr1, "Applications", ListTV);
        }
