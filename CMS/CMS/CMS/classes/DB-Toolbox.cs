...
//START DB CREATE COMMANDS
        ...
        public ArrayList EP_BUILD_CORE_STRUCTURE(string DB_PLATFORM, string connRoot, string connAuth, string connOwner, string SystemName, string Password)
        {
            ...
            switch (DB_PLATFORM)
            {
                ...
                case "MICROSOFT":
                   ...
                   Logger.Add(EP_ADD_TABLE(DB_PLATFORM, connOwner, "SamplerDampler"));
                   Logger.Add(EP_ADD_COLUMN(DB_PLATFORM, connOwner, "SamplerDampler", "samplerdupler", "varchar(4000) ", "", false));
                   Logger.Add(EP_ADD_INSERT_PROCEDURE("MICROSOFT", connOwner, "SamplerDampler", ""));
                   Logger.Add(EP_ADD_UPDATE_PROCEDURE("MICROSOFT", connOwner, "SamplerDampler", ""));
                   Logger.Add(EP_ADD_DELETE_PROCEDURE("MICROSOFT", connOwner, "SamplerDampler", ""));


                   List<ColumnStructure> ExistingColumnsList = new List<ColumnStructure>();
                   ExistingColumnsList.Add(new ColumnStructure { _Name = "samplerdupler", _DataType = "Varchar2(4000)", _DefaultValue = "", _IsNull = false });
                   Logger.Add(EP_ADD_UNIQUE_KEY(DB_PLATFORM, connOwner, "SamplerDampler", "SamplerDampler", ExistingColumnsList));
                    ...
                    ParamListOrganizations.Add(new DBParameters
                    {
                        ParamName = "@R_SamplerDampler_ID",
                        ParamDirection = ParameterDirection.Output,
                        MSSqlParamDataType = SqlDbType.Int,
                        ParamValue = ""
                    });

                    string holdvalue = SQL_PROCEDURE_GET_VALUE("@R_SamplerDampler_ID", SQL_PROCEDURE_PARAMS("MICROSOFT", connOwner, "SamplerDampler_ADD_RW", ParamListOrganizations));
                break;
            }
        ...
        public ArrayList EP_BUILD_SYSTEM_STRUCTURE(string DB_PLATFORM, string connAuth, string SystemName)
        {
            ...
            Logger.AddRange(EP_ADD_SCAFFOLD(DB_PLATFORM, constr1, "OBJECT_LAYERS", ScaffoldColumns));
            ...
            Logger.Add(EP_ADD_PRIMARY_KEY(DB_PLATFORM, constr1, "OBJECT_LAYERS_1", "OBJECT_LAYERS", ExistingColumnsList));

            //---CREATE - OBJECTS--->
            ExistingColumnsList.Clear(); MetaColumnsList.Clear(); ScaffoldColumns.Clear();
            ScaffoldColumns.Add(new ColumnStructure { _Name = "OBJECT_TYPE", _DataType = "Varchar2(50)", _DefaultValue = "", _IsNull = false });
            ScaffoldColumns.Add(new ColumnStructure { _Name = "OBJECT_LAYER", _DataType = "Varchar2(50)", _DefaultValue = "", _IsNull = false });
            Logger.AddRange(EP_ADD_SCAFFOLD(DB_PLATFORM, constr1, "OBJECTS", ScaffoldColumns));
            ...
            Logger.Add(EP_ADD_PRIMARY_KEY(DB_PLATFORM, constr1, "OBJECTS_1", "OBJECTS", ExistingColumnsList));

            //---FK - OBJECT LAYERS FOREIGN KEY 1--->
            ExistingColumnsList.Clear(); MetaColumnsList.Clear(); ScaffoldColumns.Clear();
            ExistingColumnsList.Add(new ColumnStructure { _Name = "OBJECT_LAYER", _DataType = "Varchar2(50)", _DefaultValue = "", _IsNull = false });
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "OBJECTS_1", "OBJECTS", "OBJECT_LAYERS", ExistingColumnsList, ExistingColumnsList));

            //---CREATE - LOGS--->
            ScaffoldColumns.Add(new ColumnStructure { _Name = "OBJECT_TYPE", _DataType = "varchar2(50)", _DefaultValue = "", _IsNull = false });
            ScaffoldColumns.Add(new ColumnStructure { _Name = "Entry", _DataType = "varchar2(4000)", _DefaultValue = "", _IsNull = false });
            Logger.AddRange(EP_ADD_SCAFFOLD(DB_PLATFORM, constr1, "LOGS", ScaffoldColumns));
            ...
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "LOGS_1", "LOGS", "OBJECTS", ExistingColumnsList, ExistingColumnsList));

            //---CREATE - ORGANIZATIONS--->
            ScaffoldColumns.Clear(); ExistingColumnsList.Clear(); MetaColumnsList.Clear();
            ScaffoldColumns.Add(new ColumnStructure { _Name = "OBJECT_TYPE", _DataType = "varchar2(50)", _DefaultValue = "", _IsNull = false });
            Logger.AddRange(EP_ADD_SCAFFOLD(DB_PLATFORM, constr1, "Organizations", ScaffoldColumns));

            //---FK - ORGANIZATIONS FOREIGN KEY 1--->
            ExistingColumnsList.Clear(); MetaColumnsList.Clear(); ScaffoldColumns.Clear();
            ExistingColumnsList.Add(new ColumnStructure { _Name = "OBJECT_TYPE", _DataType = "number", _DefaultValue = "", _IsNull = false });
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "ORGANIZATIONS_1", "ORGANIZATIONS", "OBJECTS", ExistingColumnsList, ExistingColumnsList));

            //---CREATE - Groups--->
            ScaffoldColumns.Clear(); ExistingColumnsList.Clear(); MetaColumnsList.Clear();
            ScaffoldColumns.Add(new ColumnStructure { _Name = "OBJECT_TYPE", _DataType = "varchar2(50)", _DefaultValue = "", _IsNull = false });
            ScaffoldColumns.Add(new ColumnStructure { _Name = "ORGANIZATIONS_ID", _DataType = "number", _DefaultValue = "", _IsNull = false });
            Logger.AddRange(EP_ADD_SCAFFOLD(DB_PLATFORM, constr1, "GROUPS", ScaffoldColumns));
            ...
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "GROUP_1", "GROUPS", "ORGANIZATIONS", ExistingColumnsList, ExistingColumnsList));

            //---FK - GROUPS FOREIGN KEY 2--->
            ExistingColumnsList.Clear(); MetaColumnsList.Clear(); ScaffoldColumns.Clear();
            ExistingColumnsList.Add(new ColumnStructure { _Name = "OBJECT_TYPE", _DataType = "number", _DefaultValue = "", _IsNull = false });
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "GROUPS_2", "GROUPS", "OBJECTS", ExistingColumnsList, ExistingColumnsList));


            //---CREATE - USERS--->
                ScaffoldColumns.Clear(); ExistingColumnsList.Clear(); MetaColumnsList.Clear();
                ScaffoldColumns.Add(new ColumnStructure { _Name = "OBJECT_TYPE", _DataType = "varchar2(50)", _DefaultValue = "", _IsNull = false });
            Logger.AddRange(EP_ADD_SCAFFOLD(DB_PLATFORM, constr1, "USERS", ScaffoldColumns));
            ...
            ExistingColumnsList.Clear(); MetaColumnsList.Clear(); ScaffoldColumns.Clear();
            ExistingColumnsList.Add(new ColumnStructure { _Name = "OBJECT_TYPE", _DataType = "number", _DefaultValue = "", _IsNull = false });
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "USERS_1", "USERS", "OBJECTS", ExistingColumnsList, ExistingColumnsList));
            ...
            Logger.AddRange(EP_ADD_SCAFFOLD(DB_PLATFORM, constr1, "GROUPS_USERS", ScaffoldColumns));
            ...
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "GROUPS_USERS_1", "GROUPS_USERS", "Users", ExistingColumnsList, ExistingColumnsList));
            ...
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "GROUPS_USERS_2", "GROUPS_USERS", "GROUPS", ExistingColumnsList, ExistingColumnsList)); 
            ...
            ScaffoldColumns.Add(new ColumnStructure { _Name = "ORGANIZATIONS_ID", _DataType = "number", _DefaultValue = "", _IsNull = false });
            ScaffoldColumns.Add(new ColumnStructure { _Name = "USERS_ID", _DataType = "number", _DefaultValue = "", _IsNull = false });
            Logger.AddRange(EP_ADD_SCAFFOLD(DB_PLATFORM, constr1, "STAGES", ScaffoldColumns));
            ...
            Logger.Add(EP_ADD_PRIMARY_KEY(DB_PLATFORM, constr1, "STAGES_1", "STAGES", ExistingColumnsList));
            ...
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "STAGES_1", "STAGES", "OBJECTS", ExistingColumnsList, MetaColumnsList));

            //---FK - STAGES FOREIGN KEY 1--->
            ExistingColumnsList.Clear(); MetaColumnsList.Clear(); ScaffoldColumns.Clear();
            ExistingColumnsList.Add(new ColumnStructure { _Name = "ORGANIZATIONS_ID", _DataType = "number", _DefaultValue = "", _IsNull = false });
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "STAGES_2", "STAGES", "ORGANIZATIONS", ExistingColumnsList, ExistingColumnsList));

            //---FK - STAGES FOREIGN KEY 1--->
            ExistingColumnsList.Clear(); MetaColumnsList.Clear(); ScaffoldColumns.Clear();
            ExistingColumnsList.Add(new ColumnStructure { _Name = "USERS_ID", _DataType = "number", _DefaultValue = "", _IsNull = false });
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "STAGES_3", "STAGES", "USERS", ExistingColumnsList, ExistingColumnsList));
            ...
            ScaffoldColumns.Add(new ColumnStructure { _Name = "ORGANIZATIONS_ID", _DataType = "number", _DefaultValue = "", _IsNull = false });
            ScaffoldColumns.Add(new ColumnStructure { _Name = "USERS_ID", _DataType = "number", _DefaultValue = "", _IsNull = false });
            Logger.AddRange(EP_ADD_SCAFFOLD(DB_PLATFORM, constr1, "GRIPS", ScaffoldColumns));         
            ...
            Logger.Add(EP_ADD_PRIMARY_KEY(DB_PLATFORM, constr1, "GRIPS_1", "GRIPS", ExistingColumnsList));
            ...
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "GRIPS_1", "GRIPS", "STAGES", ExistingColumnsList, ExistingColumnsList));

            //---FK - GRIPS FOREIGN KEY 2--->
            ExistingColumnsList.Clear(); MetaColumnsList.Clear(); ScaffoldColumns.Clear();
            ExistingColumnsList.Add(new ColumnStructure { _Name = "ORGANIZATIONS_ID", _DataType = "number", _DefaultValue = "", _IsNull = false });
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "GRIPS_2", "GRIPS", "ORGANIZATIONS", ExistingColumnsList, ExistingColumnsList));

            //---FK - GRIPS FOREIGN KEY 2--->
            ExistingColumnsList.Clear(); MetaColumnsList.Clear(); ScaffoldColumns.Clear();
            ExistingColumnsList.Add(new ColumnStructure { _Name = "USERS_ID", _DataType = "number", _DefaultValue = "", _IsNull = false });
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "GRIPS_3", "GRIPS", "USERS", ExistingColumnsList, ExistingColumnsList));
            ...
            ScaffoldColumns.Add(new ColumnStructure { _Name = "ORGANIZATIONS_ID", _DataType = "number", _DefaultValue = "", _IsNull = false });
            ScaffoldColumns.Add(new ColumnStructure { _Name = "USERS_ID", _DataType = "number", _DefaultValue = "", _IsNull = false });
            Logger.AddRange(EP_ADD_SCAFFOLD(DB_PLATFORM, constr1, "OBJECT_SETS", ScaffoldColumns));
            ...
            ExistingColumnsList.Clear(); MetaColumnsList.Clear(); ScaffoldColumns.Clear();
            ExistingColumnsList.Add(new ColumnStructure { _Name = "OBJECT_TYPE", _DataType = "Varchar2(50)", _DefaultValue = "", _IsNull = false });
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "OBJECT_SETS_1", "OBJECT_SETS", "OBJECTS", ExistingColumnsList, ExistingColumnsList));

            //---FK - OBJECTS_SETS FOREIGN KEY 2--->
            ExistingColumnsList.Clear(); MetaColumnsList.Clear(); ScaffoldColumns.Clear();
            ExistingColumnsList.Add(new ColumnStructure { _Name = "ORGANIZATIONS_ID", _DataType = "number", _DefaultValue = "", _IsNull = false });
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "OBJECT_SET_2", "OBJECT_SETS", "ORGANIZATIONS", ExistingColumnsList, ExistingColumnsList));

            //---FK - OBJECTS_SETS FOREIGN KEY 3--->
            ExistingColumnsList.Clear(); MetaColumnsList.Clear(); ScaffoldColumns.Clear();
            ExistingColumnsList.Add(new ColumnStructure { _Name = "USERS_ID", _DataType = "number", _DefaultValue = "", _IsNull = false });
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "OBJECT_SETS_3", "OBJECT_SETS", "USERS", ExistingColumnsList, ExistingColumnsList));
            ...
            ExistingColumnsList.Add(new ColumnStructure { _Name = "STAGE_NAME", _DataType = "Varchar2(50)", _DefaultValue = "", _IsNull = false });
            ExistingColumnsList.Add(new ColumnStructure { _Name = "GRIP_NAME", _DataType = "Varchar2(50)", _DefaultValue = "", _IsNull = false });  
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "OBJECT_SETS_5", "OBJECT_SETS", "GRIPS", ExistingColumnsList, ExistingColumnsList));
            ...
            Logger.AddRange(EP_ADD_SCAFFOLD(DB_PLATFORM, constr1, "OBJ_OPT_SETS", ScaffoldColumns));

            //---FK OBJECT OPTION SETS FOREIGN KEY 1--->
            ExistingColumnsList.Clear(); MetaColumnsList.Clear(); ScaffoldColumns.Clear();
            ExistingColumnsList.Add(new ColumnStructure { _Name = "OBJECT_SETS_ID", _DataType = "number", _DefaultValue = "", _IsNull = false });
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "OBJECT_OPT_SETS_1", "OBJ_OPT_SETS", "OBJECT_SETS", ExistingColumnsList, ExistingColumnsList));
            ...
            Logger.AddRange(EP_ADD_SCAFFOLD(DB_PLATFORM, constr1, "VALUE_DATATYPES", ScaffoldColumns));
            ...
            Logger.Add(EP_ADD_UNIQUE_KEY(DB_PLATFORM, constr1, "VALUE_DATATYPES_1", "VALUE_DATATYPES", ExistingColumnsList));
            ...
            Logger.AddRange(EP_ADD_SCAFFOLD(DB_PLATFORM, constr1, "OBJ_PROP_SETS", ScaffoldColumns));

            //---FK OBJECTS & PROPERTIES SETS FOREIGN KEY 1--->
            ExistingColumnsList.Clear(); MetaColumnsList.Clear(); ScaffoldColumns.Clear();
            ExistingColumnsList.Add(new ColumnStructure { _Name = "OBJECT_SETS_ID", _DataType = "number", _DefaultValue = "", _IsNull = false });
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "OBJ_PROP_SETS_1", "OBJ_PROP_SETS", "OBJECT_SETS", ExistingColumnsList, ExistingColumnsList));

            //---FK OBJECTS & PROPERTIES SETS FOREIGN KEY 1--->
            ExistingColumnsList.Clear(); MetaColumnsList.Clear(); ScaffoldColumns.Clear();
            ExistingColumnsList.Add(new ColumnStructure { _Name = "OBJECT_TYPE", _DataType = "Varchar2(50)", _DefaultValue = "", _IsNull = false });
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "OBJ_PROP_SETS_2", "OBJ_PROP_SETS", "OBJECTS", ExistingColumnsList, ExistingColumnsList));

            //---FK OBJECTS & PROPERTIES SETS FOREIGN KEY 2--->
            ExistingColumnsList.Clear(); MetaColumnsList.Clear(); ScaffoldColumns.Clear();
            ExistingColumnsList.Add(new ColumnStructure { _Name = "VALUE_DATATYPE", _DataType = "Varchar2(50)", _DefaultValue = "", _IsNull = false });
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "OBJ_PROP_SETS_3", "OBJ_PROP_SETS", "VALUE_DATATYPES", ExistingColumnsList, ExistingColumnsList));
            ...
            ScaffoldColumns.Add(new ColumnStructure { _Name = "Option_Value", _DataType = "Varchar2(50)", _DefaultValue = "", _IsNull = false });
            Logger.AddRange(EP_ADD_SCAFFOLD(DB_PLATFORM, constr1, "OBJ_PROP_OPT_SETS", ScaffoldColumns));
            ...
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "OBJ_PROP_OPT_SETS_1", "OBJ_PROP_OPT_SETS", "OBJ_PROP_SETS", ExistingColumnsList, ExistingColumnsList));
            ...
            ScaffoldColumns.Add(new ColumnStructure { _Name = "USERS_ID", _DataType = "number", _DefaultValue = "", _IsNull = false });
            ScaffoldColumns.Add(new ColumnStructure { _Name = "ORGANIZATIONS_ID", _DataType = "number", _DefaultValue = "", _IsNull = false });
            Logger.AddRange(EP_ADD_SCAFFOLD(DB_PLATFORM, constr1, "CORES", ScaffoldColumns));
            ...
            ScaffoldColumns.Clear(); ExistingColumnsList.Clear(); MetaColumnsList.Clear();
            ExistingColumnsList.Add(new ColumnStructure { _Name = "USERS_ID", _DataType = "number", _DefaultValue = "", _IsNull = false });
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "CORES_1", "CORES", "USERS", ExistingColumnsList, ExistingColumnsList));

            //---FK - CORES FOREIGN KEY 2--->
            ScaffoldColumns.Clear(); ExistingColumnsList.Clear(); MetaColumnsList.Clear();
            ExistingColumnsList.Add(new ColumnStructure { _Name = "ORGANIZATIONS_ID", _DataType = "number", _DefaultValue = "", _IsNull = false });
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "CORES_2", "CORES", "ORGANIZATIONS", ExistingColumnsList, ExistingColumnsList));

            //---FK - CORES FOREIGN KEY 1--->
            ExistingColumnsList.Clear(); MetaColumnsList.Clear(); ScaffoldColumns.Clear();
            ExistingColumnsList.Add(new ColumnStructure { _Name = "OBJECT_TYPE", _DataType = "Varchar2(50)", _DefaultValue = "", _IsNull = false });
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "CORES_3", "CORES", "OBJECTS", ExistingColumnsList, ExistingColumnsList));
            ...
            ScaffoldColumns.Add(new ColumnStructure { _Name = "USERS_ID", _DataType = "number", _DefaultValue = "", _IsNull = false });
            ScaffoldColumns.Add(new ColumnStructure { _Name = "ORGANIZATIONS_ID", _DataType = "number", _DefaultValue = "", _IsNull = false });
            Logger.AddRange(EP_ADD_SCAFFOLD(DB_PLATFORM, constr1, "APPLICATIONS", ScaffoldColumns));
            ...
            Logger.Add(EP_ADD_PRIMARY_KEY(DB_PLATFORM, constr1, "APPLICATIONS", "APPLICATIONS", ScaffoldColumns));
            ...
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "APPLICATIONS_1", "APPLICATIONS", "CORES", MetaColumnsList, ExistingColumnsList));

            //---FK - APPLICATIONS FOREIGN KEY 2--->
            ScaffoldColumns.Clear(); ExistingColumnsList.Clear(); MetaColumnsList.Clear();
            ExistingColumnsList.Add(new ColumnStructure { _Name = "USERS_ID", _DataType = "number", _DefaultValue = "", _IsNull = false });
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "APPLICATIONS_2", "APPLICATIONS", "USERS", ExistingColumnsList, ExistingColumnsList));

            //---FK - APPLICATIONS FOREIGN KEY 3--->
            ScaffoldColumns.Clear(); ExistingColumnsList.Clear(); MetaColumnsList.Clear();
            ExistingColumnsList.Add(new ColumnStructure { _Name = "ORGANIZATIONS_ID", _DataType = "number", _DefaultValue = "", _IsNull = false });
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "APPLICATIONS_3", "APPLICATIONS", "ORGANIZATIONS", ExistingColumnsList, ExistingColumnsList));

            //---FK - APPLICATIONS FOREIGN KEY 4--->
            ExistingColumnsList.Clear(); MetaColumnsList.Clear(); ScaffoldColumns.Clear();
            ExistingColumnsList.Add(new ColumnStructure { _Name = "OBJECT_TYPE", _DataType = "Varchar2(50)", _DefaultValue = "", _IsNull = false });
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "APPLICATIONS_4", "APPLICATIONS", "OBJECTS", ExistingColumnsList, ExistingColumnsList));

            //---CREATE - ROLES--->
            ScaffoldColumns.Clear(); ExistingColumnsList.Clear(); MetaColumnsList.Clear();
            ScaffoldColumns.Add(new ColumnStructure { _Name = "OBJECT_TYPE", _DataType = "Varchar2(50)", _DefaultValue = "", _IsNull = false });
            Logger.AddRange(EP_ADD_SCAFFOLD(DB_PLATFORM, constr1, "ROLES", ScaffoldColumns));

            //---FK - ROLES FOREIGN KEY 1--->
            ExistingColumnsList.Clear(); MetaColumnsList.Clear(); ScaffoldColumns.Clear();
            ExistingColumnsList.Add(new ColumnStructure { _Name = "OBJECT_TYPE", _DataType = "Varchar2(50)", _DefaultValue = "", _IsNull = false });
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "ROLES_1", "ROLES", "OBJECTS", ExistingColumnsList, ExistingColumnsList));
            
            //---CREATE - PRIVELEGES--->
            ScaffoldColumns.Clear(); ExistingColumnsList.Clear(); MetaColumnsList.Clear();
            ScaffoldColumns.Add(new ColumnStructure { _Name = "OBJECT_TYPE", _DataType = "Varchar2(50)", _DefaultValue = "", _IsNull = false });
            Logger.AddRange(EP_ADD_SCAFFOLD(DB_PLATFORM, constr1, "PRIVELEGES", ScaffoldColumns));

            //---FK - PRIVELEGES FOREIGN KEY 1--->
            ExistingColumnsList.Clear(); MetaColumnsList.Clear(); ScaffoldColumns.Clear();
            ExistingColumnsList.Add(new ColumnStructure { _Name = "OBJECT_TYPE", _DataType = "Varchar2(50)", _DefaultValue = "", _IsNull = false });
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "PRIVELEGES_1", "PRIVELEGES", "OBJECTS", ExistingColumnsList, ExistingColumnsList));
            ...
            Logger.AddRange(EP_ADD_SCAFFOLD(DB_PLATFORM, constr1, "ROLES_PRIVELEGES", ScaffoldColumns));
            ...
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "ROLES_PRIVELEGES_1", "ROLES_PRIVELEGES", "ROLES", ExistingColumnsList, ExistingColumnsList));
            ...
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "ROLES_PRIVELEGES_2", "ROLES_PRIVELEGES", "PRIVELEGES", ExistingColumnsList, ExistingColumnsList));
            ...
            ScaffoldColumns.Add(new ColumnStructure { _Name = "USERS_ID", _DataType = "number", _DefaultValue = "", _IsNull = false });
            Logger.AddRange(EP_ADD_SCAFFOLD(DB_PLATFORM, constr1, "USERS_ROLES_PRIVELEGES", ScaffoldColumns));
            ...
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "USERS_ROLES_PRIVELEGES_1", "USERS_ROLES_PRIVELEGES", "ROLES_PRIVELEGES", ExistingColumnsList, ExistingColumnsList));

            //---FK - USERS &  ROLES & PRIVELEGES FOREIGN KEY 2--->
            ScaffoldColumns.Clear(); ExistingColumnsList.Clear(); MetaColumnsList.Clear();
            ExistingColumnsList.Add(new ColumnStructure { _Name = "USERS_ID", _DataType = "number", _DefaultValue = "", _IsNull = false });
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "USERS_ROLES_PRIVELEGES_2", "USERS_ROLES_PRIVELEGES", "USERS", ExistingColumnsList, ExistingColumnsList));
            ...
            ScaffoldColumns.Add(new ColumnStructure { _Name = "ORGANIZATIONS_ID", _DataType = "number", _DefaultValue = "", _IsNull = false });
            ScaffoldColumns.Add(new ColumnStructure { _Name = "USERS_ID", _DataType = "number", _DefaultValue = "", _IsNull = false });              
            Logger.AddRange(EP_ADD_SCAFFOLD(DB_PLATFORM, constr1, "CASES", ScaffoldColumns));
            ...
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "CASES_1", "CASES", "APPLICATIONS", ExistingColumnsList, ExistingColumnsList));

            //---FK - CASES FOREIGN KEY 2--->
            ScaffoldColumns.Clear(); ExistingColumnsList.Clear(); MetaColumnsList.Clear();
            ExistingColumnsList.Add(new ColumnStructure { _Name = "USERS_ID", _DataType = "number", _DefaultValue = "", _IsNull = false });
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "CASES_2", "CASES", "USERS", ExistingColumnsList, ExistingColumnsList));

            //---FK - CASES FOREIGN KEY 3--->
            ScaffoldColumns.Clear(); ExistingColumnsList.Clear(); MetaColumnsList.Clear();
            ExistingColumnsList.Add(new ColumnStructure { _Name = "OBJECT_TYPE", _DataType = "Varchar2(50)", _DefaultValue = "", _IsNull = false });
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "CASES_3", "CASES", "OBJECTS", ExistingColumnsList, ExistingColumnsList));

            //---FK - CASES FOREIGN KEY 4--->
            ScaffoldColumns.Clear(); ExistingColumnsList.Clear(); MetaColumnsList.Clear();
            ExistingColumnsList.Add(new ColumnStructure { _Name = "ORGANIZATIONS_ID", _DataType = "number", _DefaultValue = "", _IsNull = false });
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "CASES_4", "CASES", "ORGANIZATIONS", ExistingColumnsList, ExistingColumnsList));
            ...
            ScaffoldColumns.Add(new ColumnStructure { _Name = "Organizations_ID", _DataType = "number", _DefaultValue = "", _IsNull = false });
            ScaffoldColumns.Add(new ColumnStructure { _Name = "USERS_ID", _DataType = "number", _DefaultValue = "", _IsNull = false });
            Logger.AddRange(EP_ADD_SCAFFOLD(DB_PLATFORM, constr1, "FORMS", ScaffoldColumns));

            //---FK - FORMS FOREIGN KEY 1--->
            ScaffoldColumns.Clear(); ExistingColumnsList.Clear(); MetaColumnsList.Clear();
            ExistingColumnsList.Add(new ColumnStructure { _Name = "USERS_ID", _DataType = "number", _DefaultValue = "", _IsNull = false });
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "FORMS_1", "FORMS", "USERS", ExistingColumnsList, ExistingColumnsList));

            //---FK - FORMS FOREIGN KEY 2--->
            ScaffoldColumns.Clear(); ExistingColumnsList.Clear(); MetaColumnsList.Clear();
            ExistingColumnsList.Add(new ColumnStructure { _Name = "ORGANIZATIONS_ID", _DataType = "number", _DefaultValue = "", _IsNull = false });
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "FORMS_2", "FORMS", "ORGANIZATIONS", ExistingColumnsList, ExistingColumnsList));

            //---FK - FORMS FOREIGN KEY 3--->
            ScaffoldColumns.Clear(); ExistingColumnsList.Clear(); MetaColumnsList.Clear();
            ExistingColumnsList.Add(new ColumnStructure { _Name = "OBJECT_TYPE", _DataType = "Varchar2(50)", _DefaultValue = "", _IsNull = false });
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "FORMS_3", "FORMS", "OBJECTS", ExistingColumnsList, ExistingColumnsList)); 
            ...
            ScaffoldColumns.Add(new ColumnStructure { _Name = "ORGANIZATIONS_ID", _DataType = "number", _DefaultValue = "", _IsNull = false });
            ScaffoldColumns.Add(new ColumnStructure { _Name = "USERS_ID", _DataType = "number", _DefaultValue = "", _IsNull = false });
            Logger.AddRange(EP_ADD_SCAFFOLD(DB_PLATFORM, constr1, "CASES_FORMS", ScaffoldColumns));
            ...
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "CASES_FORMS_1", "CASES_FORMS", "CASES", ExistingColumnsList, ExistingColumnsList));
            ...
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "CASES_FORMS_2", "CASES_FORMS", "FORMS", ExistingColumnsList, ExistingColumnsList));  

            //---FK - CASES & FORMS FOREIGN KEY 3--->
            ExistingColumnsList.Clear(); MetaColumnsList.Clear(); ScaffoldColumns.Clear();
            ExistingColumnsList.Add(new ColumnStructure { _Name = "USERS_ID", _DataType = "number", _DefaultValue = "", _IsNull = false });
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "CASES_FORMS_3", "CASES_FORMS", "USERS", ExistingColumnsList, ExistingColumnsList));

            //---FK - CASES & FORMS FOREIGN KEY 4--->
            ExistingColumnsList.Clear(); MetaColumnsList.Clear(); ScaffoldColumns.Clear();
            ExistingColumnsList.Add(new ColumnStructure { _Name = "ORGANIZATIONS_ID", _DataType = "number", _DefaultValue = "", _IsNull = false });
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "CASES_FORMS_4", "CASES_FORMS", "ORGANIZATIONS", ExistingColumnsList, ExistingColumnsList));
            ...
            ScaffoldColumns.Add(new ColumnStructure { _Name = "ORGANIZATIONS_ID", _DataType = "number", _DefaultValue = "", _IsNull = false });
            ScaffoldColumns.Add(new ColumnStructure { _Name = "USERS_ID", _DataType = "number", _DefaultValue = "", _IsNull = false });
            Logger.AddRange(EP_ADD_SCAFFOLD(DB_PLATFORM, constr1, "FORMS_STAGES", ScaffoldColumns));

            //---FK - FORMS & STAGES FOREIGN KEY 1--->
            ExistingColumnsList.Clear(); MetaColumnsList.Clear(); ScaffoldColumns.Clear();
            ExistingColumnsList.Add(new ColumnStructure { _Name = "STAGE_TYPE", _DataType = "Varchar2(50)", _DefaultValue = "", _IsNull = false });
            ExistingColumnsList.Add(new ColumnStructure { _Name = "STAGE_NAME", _DataType = "Varchar2(50)", _DefaultValue = "", _IsNull = false });
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "FORMS_STAGES_1", "FORMS_STAGES", "STAGES", ExistingColumnsList, ExistingColumnsList));

            //---FK - FORMS & OBJECTS STAGES FOREIGN KEY 2--->
            ExistingColumnsList.Clear(); MetaColumnsList.Clear(); ScaffoldColumns.Clear();
            ExistingColumnsList.Add(new ColumnStructure { _Name = "FORMS_ID", _DataType = "number", _DefaultValue = "", _IsNull = false });
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "FORMS_STAGES_2", "FORMS_STAGES", "FORMS", ExistingColumnsList, ExistingColumnsList));

            //---FK - FORMS & OBJECTS STAGES FOREIGN KEY 3--->
            ExistingColumnsList.Clear(); MetaColumnsList.Clear(); ScaffoldColumns.Clear();
            ExistingColumnsList.Add(new ColumnStructure { _Name = "USERS_ID", _DataType = "number", _DefaultValue = "", _IsNull = false });
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "FORMS_STAGES_3", "FORMS_STAGES", "USERS", ExistingColumnsList, ExistingColumnsList));

            //---FK - FORMS & OBJECTS STAGES FOREIGN KEY 4--->
            ExistingColumnsList.Clear(); MetaColumnsList.Clear(); ScaffoldColumns.Clear();
            ExistingColumnsList.Add(new ColumnStructure { _Name = "ORGANIZATIONS_ID", _DataType = "number", _DefaultValue = "", _IsNull = false });
            Logger.Add(EP_ADD_FOREIGN_KEY(DB_PLATFORM, constr1, "FORMS_STAGES_4", "FORMS_STAGES", "ORGANIZATIONS", ExistingColumnsList, ExistingColumnsList));



            Logger.AddRange(EP_ADD_DATA_SCAFFOLD(DB_PLATFORM, constr1, "USERS"));
            Logger.AddRange(EP_ADD_DATA_SCAFFOLD(DB_PLATFORM, constr1, "STAGES"));
            Logger.AddRange(EP_ADD_DATA_SCAFFOLD(DB_PLATFORM, constr1, "GRIPS"));
            Logger.AddRange(EP_ADD_DATA_SCAFFOLD(DB_PLATFORM, constr1, "CORES"));
            Logger.AddRange(EP_ADD_DATA_SCAFFOLD(DB_PLATFORM, constr1, "APPLICATIONS"));
            Logger.AddRange(EP_ADD_DATA_SCAFFOLD(DB_PLATFORM, constr1, "CASES"));
            Logger.AddRange(EP_ADD_DATA_SCAFFOLD(DB_PLATFORM, constr1, "FORMS"));
        ...
        public string EP_ADD_ENTRY_Organizations(string DB_PLATFORM, string connAuth)
        {
            ...
            switch (DB_PLATFORM)
            {
                ...
                case "MICROSOFT":
                    ...
                    return SQL_PROCEDURE_GET_VALUE("@R_ORGANIZATIONS_ID", SQL_PROCEDURE_PARAMS("MICROSOFT", connAuth, "ORGANIZATIONS_ADD_RW", ParamListOrganizations));
                default:
        ...
        public string EP_ADD_ENTRY_Users(string DB_PLATFORM, string connAuth)
        {
            ...
            switch (DB_PLATFORM)
            {
                ...
                case "ORACLE":
                    ...
                    return SQL_PROCEDURE_GET_VALUE("R_USERS_ID", SQL_PROCEDURE_PARAMS("ORACLE", connAuth, "USERS_ADD_RW", ParamListUsers));
                case "Microsoft":
                case "MICROSOFT":
                    ParamListUsers.Add(new DBParameters
                    {
                    ...
                    return SQL_PROCEDURE_GET_VALUE("@R_USERS_ID", SQL_PROCEDURE_PARAMS("MICROSOFT", connAuth, "USERS_ADD_RW", ParamListUsers));
                default:
                    return "Invalid DB Platform";
            }
        }
        ...
        public string EP_ADD_ENTRY_Cores(string DB_PLATFORM, string connAuth, string _Users_ID, string _Organizations_ID)
        {
            ...
            switch (DB_PLATFORM)
            {
                ...
                case "ORACLE":
                    ...
                    return SQL_PROCEDURE_GET_VALUE("R_CORES_ID", SQL_PROCEDURE_PARAMS("ORACLE", connAuth, "CORES_ADD_RW", ParamListCores));
                case "Microsoft":
                case "MICROSOFT":
                    ParamListCores.Add(new DB_Toolbox.DBParameters
                    {
                    ...
                    return SQL_PROCEDURE_GET_VALUE("@R_CORES_ID", SQL_PROCEDURE_PARAMS("MICROSOFT", connAuth, "CORES_ADD_RW", ParamListCores));
                default:
                    return "Invalid DB Platform";
            }
        }
        ...
        public string EP_ADD_ENTRY_Application(string DB_PLATFORM, string connAuth, string _Core_ID, string _Users_ID, string _Organizations_ID)
        {
            ...
            switch (DB_PLATFORM)
            {
                ...
                case "ORACLE":
                    ...
                    return SQL_PROCEDURE_GET_VALUE("R_APPLICATIONS_ID", SQL_PROCEDURE_PARAMS("ORACLE", connAuth, "APPLICATIONS_ADD_RW", ParamListApplications));
                case "Microsoft":
                case "MICROSOFT":
                    ParamListApplications.Add(new DB_Toolbox.DBParameters
                    {
                    ...
                    return SQL_PROCEDURE_GET_VALUE("@R_APPLICATIONS_ID", SQL_PROCEDURE_PARAMS("MICROSOFT", connAuth, "APPLICATIONS_ADD_RW", ParamListApplications));
                default:
                    return "Invalid DB Platform";
            }
        }

        public string EP_ADD_ENTRY_Case(string DB_PLATFORM, string connAuth, string _APP_ID, string _Users_ID)
        {
            ...
            switch (DB_PLATFORM)
            {
                ...
                case "ORACLE":
                    ...
                    return SQL_PROCEDURE_GET_VALUE("R_CASES_ID", SQL_PROCEDURE_PARAMS("ORACLE", connAuth, "CASES_ADD_RW", ParamListCases));
                case "Microsoft":
                case "MICROSOFT":
                    ParamListCases.Add(new DB_Toolbox.DBParameters
                    {
                    ...
                    return SQL_PROCEDURE_GET_VALUE("@R_CASES_ID", SQL_PROCEDURE_PARAMS("MICROSOFT", connAuth, "CASES_ADD_RW", ParamListCases));
                default:
                    return "Invalid DB Platform";
            }
        }
        ...
        public string EP_ADD_ENTRY_Form(string DB_PLATFORM, string connAuth, string _Organizations_ID, string _Users_ID)
        {
            ...
            switch (DB_PLATFORM)
            {
                ...
                case "ORACLE":
                    ...
                    return SQL_PROCEDURE_GET_VALUE("R_FORMS_ID", SQL_PROCEDURE_PARAMS("ORACLE", connAuth, "FORMS_ADD_RW", ParamListCases));
                case "Microsoft":
                case "MICROSOFT":
                    ParamListCases.Add(new DB_Toolbox.DBParameters
                    {
                    ...
                    return SQL_PROCEDURE_GET_VALUE("@R_FORMS_ID", SQL_PROCEDURE_PARAMS("MICROSOFT", connAuth, "FORMS_ADD_RW", ParamListCases));
                default:
                    return "Invalid DB Platform";
            }
        }
        ...
        public string EP_ADD_ENTRY_Form_Property(string DB_PLATFORM, string connAuth, string _FormID, string _UserID, string _Name, string _FieldType, string _Value)
        {
            ...
            switch (DB_PLATFORM)
            {
                ...
                case "ORACLE":
                    ...
                    return SQL_PROCEDURE_GET_VALUE("R_FORMS_OPTIONS_ID", SQL_PROCEDURE_PARAMS("ORACLE", connAuth, "FORMS_OPTIONS_ADD_RW", ParamListCases));
                case "Microsoft":
                case "MICROSOFT":
                    ParamListCases.Add(new DB_Toolbox.DBParameters
                    {
                    ...
                    return SQL_PROCEDURE_GET_VALUE("@R_FORMS_OPTIONS_ID", SQL_PROCEDURE_PARAMS("MICROSOFT", connAuth, "FORMS_OPTIONS_ADD_RW", ParamListCases));
                default:
                    return "Invalid DB Platform";
            }
        }
        ...
        public string EP_ADD_ENTRY_Object_Layer(string DB_PLATFORM, string connAuth, string _ObjectType)
        {
            ...
            switch (DB_PLATFORM)
            {
                ...
                case "ORACLE":
                    ...
                    return SQL_PROCEDURE_GET_VALUE("R_OBJECT_LAYERS_ID", SQL_PROCEDURE_PARAMS("ORACLE", connAuth, "OBJECT_LAYERS_ADD_RW", ParamListObjectType));
                case "Microsoft":
                case "MICROSOFT":
                    ParamListObjectType.Add(new DB_Toolbox.DBParameters
                    {
                    ...
                    return SQL_PROCEDURE_GET_VALUE("@R_OBJECT_LAYERS_ID", SQL_PROCEDURE_PARAMS("MICROSOFT", connAuth, "OBJECT_LAYERS_ADD_RW", ParamListObjectType));
                default:
                    return "Invalid DB Platform";
            }
        }
        ...
        public string EP_ADD_ENTRY_Object(string DB_PLATFORM, string connAuth, string _Name, string _ObjectLayer)
        {
            ...
            switch (DB_PLATFORM)
            {
                ...
                case "ORACLE":
                    ...
                    return SQL_PROCEDURE_GET_VALUE("R_OBJECTS_ID", SQL_PROCEDURE_PARAMS("ORACLE", connAuth, "OBJECTS_ADD_RW", ParamListObjects));
                case "Microsoft":
                case "MICROSOFT":
                    ParamListObjects.Add(new DB_Toolbox.DBParameters
                    {
                    ...
                    return SQL_PROCEDURE_GET_VALUE("@R_OBJECTS_ID", SQL_PROCEDURE_PARAMS("MICROSOFT", connAuth, "OBJECTS_ADD_RW", ParamListObjects));
                default:
                    return "Invalid DB Platform";
            }
        }
        ...
        public string EP_ADD_ENTRY_Object_Set(string DB_PLATFORM, string connAuth, string _StageType, string _StageName, string _GripName, string _ObjectType, string _OrganizationID, string _UserID)
        {
            ...
            switch (DB_PLATFORM)
            {
                ...
                case "ORACLE":
                    ...
                    return SQL_PROCEDURE_GET_VALUE("R_OBJECT_SETS_ID", SQL_PROCEDURE_PARAMS("ORACLE", connAuth, "OBJECT_SETS_ADD_RW", ParamListObjects));
                case "Microsoft":
                case "MICROSOFT":
                    ParamListObjects.Add(new DB_Toolbox.DBParameters
                    {
                    ...
                    return SQL_PROCEDURE_GET_VALUE("@R_OBJECT_SETS_ID", SQL_PROCEDURE_PARAMS("MICROSOFT", connAuth, "OBJECT_SETS_ADD_RW", ParamListObjects));
                default:
                    return "Invalid DB Platform";
            }
        }
        ...
        public string EP_ADD_ENTRY_Object_Option_Set(string DB_PLATFORM, string connAuth, string _ObjectSetID, string _OptionValue)
        {
            ...
            switch (DB_PLATFORM)
            {
                ...
                case "ORACLE":
                    ...
                    return SQL_PROCEDURE_GET_VALUE("R_OBJ_OPT_SETS_ID", SQL_PROCEDURE_PARAMS("ORACLE", connAuth, "OBJ_OPT_SETS_ADD_RW", ParamListObjects));
                case "Microsoft":
                case "MICROSOFT":
                    ParamListObjects.Add(new DB_Toolbox.DBParameters
                    {
                    ...
                    return SQL_PROCEDURE_GET_VALUE("@R_OBJ_OPT_SETS_ID", SQL_PROCEDURE_PARAMS("MICROSOFT", connAuth, "OBJ_OPT_SETS_ADD_RW", ParamListObjects));
                default:
                    return "Invalid DB Platform";
            }
        ...
        public string EP_ADD_ENTRY_Object_Property_Set(string DB_PLATFORM, string connAuth, string _ObjectsSetsID, string _ObjectType, string _ValueDatatype, string _PropertyName, string _HasParent, string _HasChild, string _ParentObjectPropID, string _PropertyValue)
        {
            ...
            switch (DB_PLATFORM)
            {
                ...
                case "ORACLE":
                    ...
                    return SQL_PROCEDURE_GET_VALUE("R_OBJ_PROP_SETS_ID", SQL_PROCEDURE_PARAMS("ORACLE", connAuth, "OBJ_PROP_SETS_ADD_RW", ParamList));
                case "Microsoft":
                case "MICROSOFT":
                    ParamList.Add(new DB_Toolbox.DBParameters
                    {
                    ...
                    return SQL_PROCEDURE_GET_VALUE("@R_OBJ_PROP_SETS_ID", SQL_PROCEDURE_PARAMS("MICROSOFT", connAuth, "OBJ_PROP_SETS_ADD_RW", ParamList));
                default:
                    return "Invalid DB Platform";
            }
        }
        ...
        public string EP_ADD_ENTRY_Object_Property_Option_Set(string DB_PLATFORM, string connAuth, string _ObjectsPropertySetsID, string _OptionValue)
        {
            ...
            switch (DB_PLATFORM)
            {
                ...
                case "ORACLE":
                    ...
                    return SQL_PROCEDURE_GET_VALUE("R_OBJ_PROP_OPT_SETS_ID", SQL_PROCEDURE_PARAMS("ORACLE", connAuth, "OBJECT_PROP_OPT_SET_ADD_RW", ParamListObjects));
                case "Microsoft":
                case "MICROSOFT":
                    ParamListObjects.Add(new DB_Toolbox.DBParameters
                    {
                    ...
                    return SQL_PROCEDURE_GET_VALUE("@R_OBJ_PROP_OPT_SETS_ID", SQL_PROCEDURE_PARAMS("MICROSOFT", connAuth, "OBJECT_PROP_OPT_SET_ADD_RW", ParamListObjects));
                default:
                    return "Invalid DB Platform";
            }
        ...
        public string EP_ADD_ENTRY_Stage(string DB_PLATFORM, string connAuth, string _StageType, string _StageName, string _Organizations_ID, string _Users_ID)
        {
            ...
            switch (DB_PLATFORM)
            {
                ...
                case "ORACLE":
                    ...
                    return SQL_PROCEDURE_GET_VALUE("R_STAGES_ID", SQL_PROCEDURE_PARAMS("ORACLE", connAuth, "STAGES_ADD_RW", ParamList));
                case "Microsoft":
                case "MICROSOFT":
                    ParamList.Add(new DB_Toolbox.DBParameters
                    {
                    ...
                    return SQL_PROCEDURE_GET_VALUE("@R_STAGES_ID", SQL_PROCEDURE_PARAMS("MICROSOFT", connAuth, "STAGES_ADD_RW", ParamList));
                default:
                    return "Invalid DB Platform";
            }
        }
        ...
        public string EP_ADD_ENTRY_Value_Datatype(string DB_PLATFORM, string connAuth, string ValueDataType)
        {
            ...
            switch (DB_PLATFORM)
            {
                ...
                case "ORACLE":
                    ...
                    return SQL_PROCEDURE_GET_VALUE("R_VALUE_DATATYPES_ID", SQL_PROCEDURE_PARAMS("ORACLE", connAuth, "VALUE_DATATYPES_ADD_RW", ParamList));
                case "Microsoft":
                case "MICROSOFT":
                    ParamList.Add(new DB_Toolbox.DBParameters
                    {
                    ...
                    return SQL_PROCEDURE_GET_VALUE("@R_VALUE_DATATYPES_ID", SQL_PROCEDURE_PARAMS("MICROSOFT", connAuth, "VALUE_DATATYPES_ADD_RW", ParamList));
                default:
                    return "Invalid DB Platform";
            }
        }
        ...
        public string EP_ADD_ENTRY_OBJECT_DATA(string DB_PLATFORM, string connAuth, string _ObjectsPropertySetsID, string _Destination, string _Destination_ID, string _ValueDataType, string _Value)
        {
            ...
            switch (DB_PLATFORM)
            {
                ...
                case "ORACLE":
                    ...
                    return SQL_PROCEDURE_GET_VALUE("R_" + sourceDestination + "_ID", SQL_PROCEDURE_PARAMS("ORACLE", connAuth, sourceDestination + "_ADD_RW", ParamList));
                case "Microsoft":
                case "MICROSOFT":
                    ParamList.Add(new DB_Toolbox.DBParameters
                    {
                    ...
                    return SQL_PROCEDURE_GET_VALUE("@R_" + sourceDestination + "_ID", SQL_PROCEDURE_PARAMS("MICROSOFT", connAuth, sourceDestination + "_ADD_RW", ParamList));
                default:
                    return "Invalid DB Platform";
            }
        ...
        public ArrayList SQL_DATA_DEFAULT(string DB_PLATFORM, string connAuth, string SystemName)
        {
            ...
            Logger.Add(EP_ADD_ENTRY_Object(DB_PLATFORM, connAuth, "ID", "Framework"));
            Logger.Add(EP_ADD_ENTRY_Object(DB_PLATFORM, connAuth, "Value", "Framework"));
            Logger.Add(EP_ADD_ENTRY_Object(DB_PLATFORM, connAuth, "Text_Box", "Application"));
            Logger.Add(EP_ADD_ENTRY_Object(DB_PLATFORM, connAuth, "Paragraph_Text", "Application"));
            Logger.Add(EP_ADD_ENTRY_Object(DB_PLATFORM, connAuth, "Rich_Text", "Application"));
            Logger.Add(EP_ADD_ENTRY_Object(DB_PLATFORM, connAuth, "Check_Box", "Application"));
            Logger.Add(EP_ADD_ENTRY_Object(DB_PLATFORM, connAuth, "Radio_Button", "Application"));
            Logger.Add(EP_ADD_ENTRY_Object(DB_PLATFORM, connAuth, "Drop_Down", "Application"));
            Logger.Add(EP_ADD_ENTRY_Object(DB_PLATFORM, connAuth, "Section", "Application"));
            Logger.Add(EP_ADD_ENTRY_Object(DB_PLATFORM, connAuth, "Page_Break", "Application"));
            Logger.Add(EP_ADD_ENTRY_Object(DB_PLATFORM, connAuth, "Number", "Application"));

            Logger.Add(EP_ADD_ENTRY_Object(DB_PLATFORM, connAuth, "Email", "Application"));
            Logger.Add(EP_ADD_ENTRY_Object(DB_PLATFORM, connAuth, "Url", "Application"));
            Logger.Add(EP_ADD_ENTRY_Object(DB_PLATFORM, connAuth, "Date", "Application"));
            Logger.Add(EP_ADD_ENTRY_Object(DB_PLATFORM, connAuth, "Time", "Application"));
            Logger.Add(EP_ADD_ENTRY_Object(DB_PLATFORM, connAuth, "Phone", "Application"));
            Logger.Add(EP_ADD_ENTRY_Object(DB_PLATFORM, connAuth, "Credit_Card", "Application"));
            Logger.Add(EP_ADD_ENTRY_Object(DB_PLATFORM, connAuth, "File_Upload", "Application"));
            ...
            Cases_ID = EP_ADD_ENTRY_Case(DB_PLATFORM, connAuth, APP_ID, Users_ID);
...
//START COMMON DATATABASE COMMANDS
        ...
        public ArrayList EP_ADD_DATA_SCAFFOLD(string DB_PLATFORM, string connAuth, string TableName)
        {
            ...
            HoldResult.Add(EP_ADD_TABLE("ORACLE", connAuth, Char_Table));
            HoldResult.Add(EP_ADD_TABLE("ORACLE", connAuth, Number_Table));
            HoldResult.Add(EP_ADD_TABLE("ORACLE", connAuth, Date_Table));
